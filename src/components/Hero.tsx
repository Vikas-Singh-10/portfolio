      ...
      <div className="relative z-10 mb-10 flex justify-center">
        <div className="flex max-w-[89vw] flex-col items-center justify-center md:max-w-2xl lg:max-w-[60vw]">
          ...
          <p className="mb-4 text-center text-sm md:text-lg md:tracking-wider lg:text-2xl">
            Hi, I&apos;m Vikas, a passionate Full-Stack Developer from India. I
            specialize in building high-performance web applications using
            technologies like Next.js, Node.js, MongoDB, AWS Lambda, Firebase,
            and TypeScript.
          </p>
          <p className="mb-4 text-center text-sm md:text-lg md:tracking-wider lg:text-2xl">
            I have hands-on experience with serverless architectures, real-time
            notifications, scalable search with Algolia, and mobile development
            using Flutter. My focus is always on delivering seamless user
